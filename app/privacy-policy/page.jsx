...
export const metadata = {
  title: "Privacy Policy — Gabriel Rasmussen",
          ...
          <main id="main" className="page-section">
            <div className="container position-relative">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Gabriel
                    Rasmussen, Copenhagen, Denmark.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Gabriel Rasmussen,
                    accessible from{" "}
                    <a
                      href="https://gabriel-rasmussen.pages.dev"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://gabriel-rasmussen.pages.dev/
                    </a>
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>
                  By email:{" "}
                  <a href="mailto:hello@gabriel-rasmussen.pages.dev">
                    hello@gabriel-rasmussen.pages.dev
                  </a>
                </li>
              </ul>
            </div>
